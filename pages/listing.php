...
if ($result = $db->query("SELECT * FROM products ORDER BY product_id DESC")){
    ...
    <div class="centre bloc__listing ">
                    <div class="row produit_listing " id="art_20486362">
                        <div class="w30 img-content">
                            <a href="homePage.php?product_id=<?php echo $value['product_id']; ?>" class="figure">
                        ...
                        <div class="w70 list-content" data-url="">
                            ...
                            <div class="line mtm nav-list-card">
                                <div class="txtright fr small-hidden tiny-hidden ">
                                    ...
                                    <a class="btn btn-validation " href="homePage.php?product_id=<?php echo $value['product_id']; ?>">Plus de détails</a>
                                </div>
                            </div>
                        </div>
                    </div>
