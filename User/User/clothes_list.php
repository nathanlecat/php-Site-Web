...
<div class="container-fluid main-container">
    ...
    <div class="col-md-9 content" style="margin-left:10px">
        <div class="panel-heading" style="background-color:#c4e17f">
            <h1>Products list / Page <?php echo $page;?> </h1><a class=' btn btn-primary' href='index.php'>Retour Dashboard</a></div>
        <br>

        <div class='table-responsive'>
            <div style="overflow-x:scroll;">
                <table class="table  table-hover table-striped" style="font-size:18px">
                    <tr><th>Image</th><th>Name</th><th>Price</th><th>pieces</th><th>Room</th><th>Supprimer</th>

                    <?php

                    $result=mysqli_query($con,"select product_id,product_image, product_title,product_price, product_piece, product_room from products  where  product_cat=2 or product_cat=3 or product_cat=4 Limit $page1,10")or die ("query 1 incorrect.....");

                    while(list($product_id,$image,$product_name,$price, $piece, $room)=mysqli_fetch_array($result))
                    {
