              ...
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    ...
                    <tbody>
                      <?php
                        $result=mysqli_query($con,"select * from products")or die ("query 1 incorrect.....");

                        while(list($product_id,$product_title,$last_name,$email,$password,$phone,$address1,$address2)=mysqli_fetch_array($result))
                        {
                        echo "<tr><td>$product_id</td><td>$product_title</td><td>$last_name</td><td>$email</td><td>$password</td><td>$phone</td><td>$address1</td><td>$address2</td>
            ...
            <div class="card ">
              ...
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                        <tr><th>ID</th><th>Status:</th><th>Nb:</th>
                    </tr></thead>
                    <tbody>
                      <?php 
